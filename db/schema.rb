...
ActiveRecord::Schema.define(version: 20_181_120_132_336) do
  ...
  create_table 'force_rates', force: :cascade do |t|
    t.string 'rate', null: false
    t.integer 'valute', default: 0
    t.datetime 'expired_at', null: false
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index ['valute'], name: 'index_force_rates_on_valute', unique: true
  end
